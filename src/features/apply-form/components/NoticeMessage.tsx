export const NoticeMessage = () => {
  return (
    <ol className='list-outside list-decimal space-y-[1px] pl-4 text-[15px]'>
      <li className='hanging-indent-6 leading-relaxed'>
        대여 가능 기간은 대여장부 작성일로부터
        <b className='text-sun'> 최대 일주일</b>입니다. 다시 대여해주세요.
      </li>
      <li className='hanging-indent-6 leading-relaxed'>
      ...
      <li className='hanging-indent-6 leading-relaxed'>
        ...
        <b className='text-sun'> 1회의 제재 횟수가 추가</b>
        됩니다.
      </li>
      <li className='hanging-indent-6 leading-relaxed'>
        1회 이상 제재를 받을 경우
        <b className='text-sun'> 일주일간 물품 대여가 제한</b>
        됩니다.
      </li>
      <li className='hanging-indent-6 leading-relaxed'>
        3회 이상 제재를 받을 경우
        <b className='text-sun'> 물품 대여가 영구적으로 제한</b>
        됩니다.
      </li>
      <li className='hanging-indent-6 leading-relaxed'>
